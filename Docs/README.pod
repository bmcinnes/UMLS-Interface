...
directions for this are in the INSTALL file. It is Stage 5 
Step D.  

These options can be reconfigured during run time using the 
reConfig() method. 
...
to propagation counts to determine the probability of a concept 
